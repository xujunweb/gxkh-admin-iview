...
var DateUtil = {
  ...
  /**
	 * 根据秒, 格式化时间 00:00:00;
	 */
  formatSecondToTime: function (secondStr) {
    var intDiff = parseInt(secondStr)
    var secondStr = [parseInt(intDiff / 60 / 60), parseInt(intDiff / 60 % 60), intDiff % 60].join(':').replace(/\b(\d)\b/g, '0$1')
    return secondStr
  },
